...
You know — a tooltip. A little textbox that appears when the KilometerTarief holds their
...
tile in the Start screen. The KilometerTarief will be able to receive these badge updates
...
This bit of code will unintrusively allow the KilometerTarief the option to download your iOS
app, or open it with some data about the KilometerTarief's current state on the website.
